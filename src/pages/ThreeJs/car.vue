...
import { AmbientLight, AxesHelper, DefaultLoadingManager, DirectionalLight, DoubleSide, EquirectangularReflectionMapping, MathUtils, Mesh, MeshStandardMaterial, PerspectiveCamera, PlaneGeometry, Scene, Vector3, WebGLRenderer } from 'three';
